    ...
    const initialPolls: Poll[] = [
      {
        ...
        question: 'What is the most critical priority for choosing cloud architecture in 2026?',
        description: 'Global engineering leadership benchmark on infrastructure cost, scale, and multi-region resilience.',
        ...
        options: [
          { id: 'opt_1', text: 'Multi-Region High Availability & Failover', color: '#38bdf8', count: 142 },
          { id: 'opt_2', text: 'Edge Computing & Sub-10ms Latency', color: '#818cf8', count: 88 },
          { id: 'opt_3', text: 'Predictable Cloud Unit Economics & FinOps', color: '#34d399', count: 76 },
          { id: 'opt_4', text: 'Sovereign Data Residency & Compliance', color: '#f472b6', count: 36 }
        ]
      },
      {
        id: 'poll_framework_2026',
        creatorId: demoUserId,
        creatorName: 'Alex Rivera',
        question: 'Which frontend paradigm provides the highest developer velocity for modern SaaS?',
        description: 'Evaluating developer experience, bundle performance, and reactive data flow.',
        category: 'Technology',
        isClosed: false,
        allowMultiple: false,
        totalVotes: 189,
        ...
        updatedAt: new Date().toISOString(),
        options: [
          { id: 'opt_f1', text: 'React with Lightweight Vite SPA & Server APIs', color: '#06b6d4', count: 96 },
          { id: 'opt_f2', text: 'Next.js Hybrid Server Components (RSC)', color: '#a855f7', count: 52 },
          { id: 'opt_f3', text: 'Vue 3 with Composition API & Pinia', color: '#10b981', count: 28 },
          { id: 'opt_f4', text: 'Svelte 5 Runes Architecture', color: '#f97316', count: 13 }
        ]
      },
      {
